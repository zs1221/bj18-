    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(verbose_name='更新时间', auto_now=True)),
                ('is_delete', models.BooleanField(verbose_name='删除标记', default=False)),
                ('order_id', models.CharField(verbose_name='订单编号', primary_key=True, max_length=20, serialize=False)),
                ...
                ('trade_no', models.CharField(verbose_name='支付编号', max_length=20, default='')),
            ],
            options={
                'verbose_name': '订单信息',
